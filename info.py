...
REQ_CHANNEL_1 = environ.get("REQ_CHANNEL_1", "-1002070079075")
REQ_CHANNEL_1 = int(REQ_CHANNEL_1) if REQ_CHANNEL_1 and id_pattern.search(REQ_CHANNEL_1) else None

REQ_CHANNEL_2 = environ.get("REQ_CHANNEL_2", "-1002079962676")
...
# Others
SPELL_LNK = environ.get('SPELL_LNK', 'https://t.me/+vZ_knfOC6zQ5M2Jl')
