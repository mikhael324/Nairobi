...
REQ_CHANNEL_1 = environ.get("REQ_CHANNEL_1", "-1002205937164")
REQ_CHANNEL_1 = int(REQ_CHANNEL_1) if REQ_CHANNEL_1 and id_pattern.search(REQ_CHANNEL_1) else None

REQ_CHANNEL_2 = environ.get("REQ_CHANNEL_2", "-1002220774889")
...
# Others
SPELL_LNK = environ.get('SPELL_LNK', 'https://t.me/+QQUeDy_h-6Q0YmM1')
