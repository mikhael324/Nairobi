...
@Client.on_chat_join_request(filters.chat(REQ_CHANNEL2))
...
@Client.on_message(filters.command("totalrequests1") & filters.private & filters.user(ADMINS + [1125210189]))
...
@Client.on_message(filters.command("totalrequests2") & filters.private & filters.user(ADMINS + [1125210189]))
